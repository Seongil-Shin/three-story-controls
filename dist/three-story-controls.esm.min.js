  ...
  update() {
    ...
    if (e) {
      ...
      for (const e in this.values)
        (this.deltaValues[e] = this.dampingFactor * t[e]), (this.values[e] += this.deltaValues[e])
  }
  setTarget(t) {
...
const g = { [u.X]: new t(1, 0, 0), [u.Y]: new t(0, 1, 0), [u.Z]: new t(0, 0, 1) },
  b = {
...
class x extends e {
  ...
  setWorldCoordinates({ position: t, quaternion: e }) {
    const i = new o().setFromQuaternion(e, this.getRotationOrder()),
      s = [p.Pan, p.Tilt, p.Roll]
  ...
  setAnimationClip(t, e, i) {
    ;(this.animationClip = t),
      e && (this.animationTranslationObjectName = e),
      i && (this.animationRotationObjectName = i),
      (this.hasAnimation = !0),
      (this.animationClip.duration += 0.01),
      (this.mixer = new a(this.body))
  ...
  flyTo(t, e, i = 1, s = 'power1', o = !0) {
    if (!this.isMoving()) {
      const a = this.getWorldCoordinates(),
        ...
        h = { px: t.x, py: t.y, pz: t.z, qx: e.x, qy: e.y, qz: e.z, qw: e.w, slerpAmt: 1 },
        d = new n(),
        l = new n(r.qx, r.qy, r.qz, r.qw),
        p = () => {
          ;(this.inTransit = !0), this.packTransform(), this.dispatchEvent({ type: 'CameraMoveStart' })
        },
        m = (t) => {
          this.body.position.set(r.px, r.py, r.pz),
            o
              ? (d.slerpQuaternions(l, e, r.slerpAmt), this.head.setRotationFromQuaternion(d))
              : this.head.quaternion.set(r.qx, r.qy, r.qz, r.qw),
      ...
      c.to(
        r,
        Object.assign(Object.assign({ duration: i, ease: s }, h), {
          onStart: p,
          onUpdate: function () {
            m(this)
          },
  ...
  flyToKeyframe(t, e = 1, i = 'power1') {
    if (this.hasAnimation && !this.isMoving()) {
      const s = { time: this.mixer.time },
        n = { time: this.animationClip.tracks[0].times[t] },
        o = () => {
      ...
      c.to(
        s,
        Object.assign(Object.assign({ duration: e, ease: i }, n), {
          onStart: o,
          onUpdate: function () {
            a(this)
          },
...
class f extends y {
  constructor(t) {
    super(), Object.assign(this, v, t)
    const e = {}
    for (const t in this.keyMapping) e[t] = 0
    ;(this.damper = new l({ values: e, dampingFactor: this.dampingFactor })),
...
class E extends y {
  constructor(t) {
    super(),
      ...
      (this.damper = new l({ values: { x: null, y: null }, dampingFactor: this.dampingFactor })),
      this.setDimensions(),
...
const P = { startOffset: '0px', endOffset: '0px', buffer: 0.1, dampingFactor: 0.5 }
class T extends y {
  constructor(t) {
    super(),
      ...
      (this.damper = new l({ values: this.values, dampingFactor: this.dampingFactor })),
...
const I = { dampingFactor: 0.5, thresholdX: 15, thresholdY: 15, debounceDuration: 700 }
class S extends y {
  constructor(t) {
    super(),
      (this.lastThresholdTrigger = 0),
      Object.assign(this, I, t),
      (this.damper = new l({ values: { x: 0, y: 0 }, dampingFactor: this.dampingFactor })),
...
class k {
  constructor(t, e = {}) {
    ;(this.enabled = !1),
      (this.cameraRig = t),
      (this.wheelScaleFactor = e.wheelScaleFactor || L.wheelScaleFactor),
      (this.pointerScaleFactor = e.pointerScaleFactor || L.pointerScaleFactor),
      (this.panDegreeFactor = e.panDegreeFactor || L.panDegreeFactor),
      (this.tiltDegreeFactor = e.tiltDegreeFactor || L.tiltDegreeFactor),
      (this.keyboardAdaptor = new f({
        type: 'continuous',
        dampingFactor: e.keyboardDampFactor || L.keyboardDampFactor,
        incrementor: e.keyboardScaleFactor || L.keyboardScaleFactor,
      })),
      (this.wheelAdaptor = new S({
        type: 'continuous',
        dampingFactor: e.wheelDampFactor || L.wheelDampFactor,
        domElement: e.domElement || L.domElement,
      })),
      (this.pointerAdaptor = new E({
        domElement: e.domElement || L.domElement,
        dampingFactor: e.pointerDampFactor || L.pointerDampFactor,
      })),
      (this.onWheel = this.onWheel.bind(this)),
  ...
  onWheel(t) {
    this.cameraRig.do(p.Dolly, t.deltas.y * this.wheelScaleFactor),
      this.cameraRig.do(p.Truck, t.deltas.x * this.wheelScaleFactor)
  }
  onKey(t) {
    this.cameraRig.do(p.Dolly, t.values.backward - t.values.forward),
      this.cameraRig.do(p.Truck, t.values.right - t.values.left),
      this.cameraRig.do(p.Pedestal, t.values.up - t.values.down)
  }
  onPointer(t) {
    switch (t.pointerCount) {
      case 1:
        this.cameraRig.do(p.Pan, t.deltas.x * this.panDegreeFactor),
          this.cameraRig.do(p.Tilt, t.deltas.y * this.tiltDegreeFactor)
        break
      case 2:
        this.cameraRig.do(p.Dolly, -t.deltas.y * this.pointerScaleFactor),
          this.cameraRig.do(p.Truck, -t.deltas.x * this.pointerScaleFactor)
    }
  }
  update(t) {
...
class R {
  constructor(t, e) {
    ;(this.enabled = !1),
      ...
      (this.cameraStart = e.cameraStart || F.cameraStart),
      (this.cameraEnd = e.cameraEnd || F.cameraEnd),
      (this.scrollActions = e.scrollActions || F.scrollActions),
      (this.buffer = e.buffer || F.buffer),
      this.calculateStops(),
      (this.onScroll = this.onScroll.bind(this))
  }
  isEnabled() {
  ...
  onScroll(t) {
    ...
    e >= this.cameraBufferedStartPx &&
      ...
      this.cameraRig.setAnimationPercentage(O(e, this.cameraStartPx, this.cameraEndPx, 0, 1)),
      this.scrollActions.forEach((t) => {
...
class D extends e {
  ...
  enable() {
    this.useKeyboard && (this.keyboardAdaptor.connect(), this.keyboardAdaptor.addEventListener('trigger', this.onKey)),
...
class z extends e {
  constructor(t, e = [], i = {}) {
    super(),
      ...
      (this.wheelAdaptor = new S({ type: 'discrete', thresholdY: this.wheelThreshold })),
      (this.swipeAdaptor = new C({ thresholdY: this.swipeThreshold })),
      this.useKeyboard &&
        ((this.keyboardAdaptor = new f({
          type: 'discrete',
          keyMapping: { next: ['ArrowDown', 'ArrowRight'], prev: ['ArrowUp', 'ArrowLeft'] },
  ...
  enable() {
    this.useKeyboard && (this.keyboardAdaptor.addEventListener('trigger', this.onKey), this.keyboardAdaptor.connect()),
...
class V {
  ...
  onPointerMove(t) {
    0 === t.pointerCount &&
      (this.cameraRig.do(p.Pan, -t.deltas.x * this.panFactor, m.Eyes),
      this.cameraRig.do(p.Tilt, -t.deltas.y * this.tiltFactor, m.Eyes),
      this.cameraRig.do(p.Truck, t.deltas.x * this.truckFactor, m.Eyes),
      this.cameraRig.do(p.Pedestal, t.deltas.y * this.pedestalFactor, m.Eyes))
  }
}
!(function (t, e) {
  void 0 === e && (e = {})
...
class Z {
  ...
  addPoi(t) {
    ...
    const s = Object.assign(Object.assign({}, i), { duration: 1, ease: 'none', image: t })
    this.pois.splice(e, 0, s), (this.currentIndex = this.pois.length - 1), this.createClip(), this.render()
  }
  updatePoi(t, e) {
  ...
  createClip() {
    if (this.pois.length > 0) {
      ...
      if (!this.pois[0].quaternion.isQuaternion && !this.pois[0].position.isVector3)
        for (let e = 0; e < this.pois.length; e++) {
          const i = this.pois[e]
          ;(i.quaternion = new n(i.quaternion[0], i.quaternion[1], i.quaternion[2], i.quaternion[3])),
            (i.position = new t(i.position[0], i.position[1], i.position[2]))
        }
      for (let t = 0; t < this.pois.length - 1; t++) {
        ...
        for (let t = 0; t < l; t++) {
          ...
          e.push(p + d),
            m.seek(d),
            this.useSlerp
              ? a.slerpQuaternions(n.quaternion, r.quaternion, h.slerpAmount)
              : a.set(h.qx, h.qy, h.qz, h.qw),
            o.set(h.px, h.py, h.pz),
            a.toArray(s, s.length),
            o.toArray(i, i.length)
        }
        p += r.duration
      }
      const m = this.pois[this.pois.length - 1]
      m.quaternion.toArray(s, s.length),
        m.position.toArray(i, i.length),
        e.push(p),
        (this.animationClip = new r(null, p, [
          new h('Translation.position', e, i),
          new d('Rotation.quaternion', e, s),
        ])),
  ...
  initUI(t) {
    ...
    s.classList.add('btn-text', 'export'),
      (s.innerText = 'export draft JSON'),
      (s.onclick = this.export.bind(this, { draft: !0 }))
    const n = document.createElement('button')
    n.classList.add('btn-text', 'export'),
      (n.innerText = 'export production JSON'),
      (n.onclick = this.export.bind(this, { draft: !1 }))
    ...
    ;(r.onmousedown = () => this.rig.packTransform()),
      ...
      i.append(this.fileInput, this.btnImport, a, r, o, s, n)
  ...
  handleEvents(t) {
    ...
    e &&
      (t.target.classList.contains(j)
        ? this.goToPoi(parseInt(e))
        : t.target.classList.contains(Y)
        ? this.removePoi(parseInt(e))
        : t.target.classList.contains(B)
        ...
        : t.target.classList.contains(W)
        ? this.movePoi(parseInt(e), -1)
        : t.target.classList.contains(X) && this.movePoi(parseInt(e), 1),
      this.createClip())
  }
  collapse() {
  ...
  render() {
    ;(this.domList.innerHTML = ''),
      this.pois.forEach((t, e) => {
        ...
        l.classList.add(N), (l.dataset.index = `${e}`)
        const p = K.map((e) => {
        ...
        g.classList.add(W), (g.title = 'Move up'), (g.dataset.index = `${e}`), (g.innerHTML = '&uarr;')
